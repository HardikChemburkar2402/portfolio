/* Section heading w/ mono number — the bchiang7/v4 "01." motif, light + blue */
...
function Summary() {
  return (
    <section id="summary" className="sec" data-screen-label="Summary">
...
function Experience() {
  return (
    <section id="experience" className="sec" data-screen-label="Experience">
      <div className="glass sec-panel">
...
function Skills() {
  return (
    <section id="skills" className="sec" data-screen-label="Skills">
      <div className="glass sec-panel">
...
function Education() {
  return (
    <section id="education" className="sec" data-screen-label="Education">
      <div className="glass sec-panel">
...
Object.assign(window, { SectionHead, Summary, Experience, Skills, Education });
